...
# 跨域配置
ALLOWED_HOSTS = ["*"]
CORS_ORIGIN_ALLOW_ALL = local_configs.SERVER.CORS_ALLOW_ALL
CORS_ALLOW_CREDENTIALS = local_configs.SERVER.CORS_ALLOW_CREDENTIAL
CORS_ORIGIN_WHITELIST = local_configs.SERVER.CORS_WHITELIST
CORS_ALLOW_HEADERS = [
    "accept",
    "accept-encoding",
    "authorization",
