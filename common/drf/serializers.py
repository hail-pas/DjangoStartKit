...
from rest_framework.fields import SkipField, DateTimeField, empty, ChoiceField
...
class CustomModelSerializer(ModelSerializer):
    ...
    def get_field_names(self, declared_fields, info):
        ...
        property_names = [name for name in dir(self.Meta.model) if
                          isinstance(getattr(self.Meta.model, name), property)]
